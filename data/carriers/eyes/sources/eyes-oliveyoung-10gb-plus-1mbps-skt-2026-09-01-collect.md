# [S]올리브영10GB+1Mbps — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/525/C01
...
| 정가(취소선) | 33,000원 |
| 표시가 | 첫 7개월간 월 9,500원 |
| 제휴 혜택 | 매 월 올리브영 7,000원 상품권 (정가 7,000원) / SOLO 결합 시 추가 10GB X 24개월 |
...
```
id            eyes-oliveyoung-10gb-plus-1mbps-skt
