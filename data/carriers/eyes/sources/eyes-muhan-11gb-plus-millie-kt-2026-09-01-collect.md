# [K]무한11GB+ 밀리의서재 — 원문에서 본 값 (2026-09-01 확인, 라운드 2 — 일 단위 데이터)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/277/C01
...
| 정가(취소선) | 45,100원 |
| 표시가 | 평생 월 25,500원 |
| 제휴 혜택 | 밀리의서재 전자책 월 정기구독 무료 (정가 11,900원) / SOLO 결합 시 추가 20GB |
...
```
id            eyes-muhan-11gb-plus-millie-kt
