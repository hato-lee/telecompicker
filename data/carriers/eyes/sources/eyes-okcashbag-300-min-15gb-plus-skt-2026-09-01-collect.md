# [S]OK캐쉬백 300분/15GB+ — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/600/C01
...
| 칸 | 원문 |
|---|---|
| 요금제 | [S]OK캐쉬백 300분/15GB+ |
| 배지 | SKT · OK캐쉬백 · 12개월 할인 |
| 데이터 | 15GB + 3Mbps |
| 통화 | 300분 |
| 문자 | 300건 |
| 정가(취소선) | 41,800원 |
| 표시가 | 첫 12개월간 월 24,500원 |
| 제휴 혜택 | 매월 OK캐쉬백 5,000P (정가 5,000원) / SOLO 결합 시 추가 10GB X 24개월 |
