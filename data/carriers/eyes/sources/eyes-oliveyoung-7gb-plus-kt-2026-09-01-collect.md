# [K]올리브영 7GB+ — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/583/C01
...
| 정가(취소선) | 없음 |
| 표시가 | 월 25,300원 |
| 제휴 혜택 | 매 월 올리브영 5,000원 상품권 (정가 5,000원) / SOLO 결합 시 추가 5GB |
...
```
id            eyes-oliveyoung-7gb-plus-kt
