# [K]무한100분/15GB+ Npay — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/249/C01
...
| 칸 | 원문 |
|---|---|
| 요금제 | [K]무한100분/15GB+ Npay |
| 배지 | KT · Npay · 7개월 할인 |
| 데이터 | 15GB + 3Mbps |
| 통화 | 100분 |
| 문자 | 100건 |
| 정가(취소선) | 38,500원 |
| 표시가 | 첫 7개월간 월 12,000원 |
| 제휴 혜택 | 매 월 Npay 5,000P (정가 5,000원) / SOLO 결합 시 추가 10GB |
