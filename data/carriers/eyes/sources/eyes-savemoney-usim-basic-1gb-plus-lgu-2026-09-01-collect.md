# 세이브머니유심(기본제공/1GB+) — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/275/C01
...
| 칸 | 원문 |
|---|---|
| 요금제 | 세이브머니유심(기본제공/1GB+) |
| 배지 | LGU+ |
| 데이터 | 1GB + 1Mbps |
| 통화 | 기본제공 + 영상/부가통화 110분 |
| 문자 | 기본제공 |
| 정가(취소선) | 없음 |
| 표시가 | 월 8,030원 |
...
```
id            eyes-savemoney-usim-basic-1gb-plus-lgu
