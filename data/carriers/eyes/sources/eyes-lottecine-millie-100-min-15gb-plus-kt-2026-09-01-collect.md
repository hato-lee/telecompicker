# [K]롯시&밀리 100분/15GB+ — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/413/C01
...
| 정가(취소선) | 38,500원 |
| 표시가 | 첫 7개월간 월 6,900원 |
| 제휴 혜택 | 매 월 롯데시네마 관람권 & 콤보 할인 (정가 15,000원) / 밀리의서재 전자책 월 정기구독 무료 (정가 11,900원) / SOLO 결합 시 추가 10GB |
...
```
id            eyes-lottecine-millie-100-min-15gb-plus-kt
