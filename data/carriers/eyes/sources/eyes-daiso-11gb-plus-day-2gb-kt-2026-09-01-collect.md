# [K]다이소 11GB+일2GB — 원문에서 본 값 (2026-09-01 확인, 라운드 2 — 일 단위 데이터)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/582/C01
...
| 제휴 혜택 | 매 월 다이소 5,000원 상품권 (정가 5,000원) / SOLO 결합 시 추가 20GB |
...
```
id            eyes-daiso-11gb-plus-day-2gb-kt
