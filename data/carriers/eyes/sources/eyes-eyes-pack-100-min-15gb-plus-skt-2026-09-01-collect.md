# [S]아이즈팩 100분/15GB+ — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/620/C01
...
| 정가(취소선) | 35,200원 |
| 표시가 | 첫 7개월간 월 7,700원 |
| 제휴 혜택 | CU 10%할인 모바일상품권 / 온라인 뉴스콘텐츠 구독 (정가 15,000원) / 교보문고 전자책 sam 이용 (정가 7,000원) / SOLO 결합 시 추가 10GB X 24개월 |
...
```
id            eyes-eyes-pack-100-min-15gb-plus-skt
