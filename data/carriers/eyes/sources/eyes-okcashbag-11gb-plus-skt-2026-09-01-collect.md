# [S]OK캐쉬백 11GB+ — 원문에서 본 값 (2026-09-01 확인, 라운드 2 — 일 단위 데이터)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/601/C01
...
| 문자 | 기본제공 |
| 정가(취소선) | 48,400원 |
| 표시가 | 첫 12개월간 월 26,900원 |
| 제휴 혜택 | 매월 OK캐쉬백 5,000P (정가 5,000원) / SOLO 결합 시 추가 20GB X 24개월 |
