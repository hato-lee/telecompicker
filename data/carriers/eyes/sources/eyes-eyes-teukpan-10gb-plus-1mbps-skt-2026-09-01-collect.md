# [S]아이즈특판10GB+1Mbps — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/365/C01
...
| 칸 | 원문 |
|---|---|
| 요금제 | [S]아이즈특판10GB+1Mbps |
| 배지 | SKT · 7개월 할인 |
| 데이터 | 10GB + 1Mbps |
| 통화 | 기본제공 + 영상/부가통화 300분 |
| 문자 | 기본제공 |
| 정가(취소선) | 20,900원 |
| 표시가 | 첫 7개월간 월 10,500원 |
| 제휴 혜택 | SOLO 결합 시 추가 10GB X 24개월 |
