# [S]올리브영7GB+ — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/533/C01
...
| 정가(취소선) | 27,500원 |
| 표시가 | 첫 7개월간 월 5,500원 |
| 제휴 혜택 | 매 월 올리브영 7,000원 상품권 (정가 7,000원) / SOLO 결합 시 추가 5GB X 24개월 |
...
```
id            eyes-oliveyoung-7gb-plus-skt
