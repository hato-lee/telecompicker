# [K]다이소 300분/15GB+ — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://www.eyes.co.kr/payplan/plan_info/579/C01
...
| 정가(취소선) | 없음 |
| 표시가 | 월 39,600원 |
| 제휴 혜택 | 매 월 다이소 5,000원 상품권 (정가 5,000원) / SOLO 결합 시 추가 10GB |
...
```
id            eyes-daiso-300-min-15gb-plus-kt
