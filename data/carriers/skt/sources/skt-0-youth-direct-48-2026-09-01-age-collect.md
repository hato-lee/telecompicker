# 0 청년 다이렉트 48 — 원문에서 본 값 (2026-09-01, 라운드 2 · 연령 전용)

- 요금제 id(우리): `skt-0-youth-direct-48`
- T world 상품코드: `NA00008157`
- 상세/공시 페이지: https://www.tworld.co.kr/web/product/callplan/NA00008157
...
- 공시 API: https://www.tworld.co.kr/core-product/v1/ledger/NA00008157/summaries · .../contents
- 확인 날짜: 2026-09-01
...
| 공유/테더링 한도(shrDataQtyCtt) | 50 |
| 목록 분류(prodFltList) | 5G, 만 34세 이하, 8GB~, 4~5만원대 |

## 우리 그릇에 담은 값

```json
{
  "id": "skt-0-youth-direct-48",
  "carrier": "SK텔레콤",
  "carrierType": "mno",
  "network": "SKT",
  "name": "0 청년 다이렉트 48",
  ...
  "ageMin": null,
  "ageMax": 34,
  "sourceUrl": "https://www.tworld.co.kr/web/product/callplan/NA00008157",
