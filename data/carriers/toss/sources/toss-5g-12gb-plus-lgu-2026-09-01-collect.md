# 5G 12GB+ (LGU 망) — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://tossmobile.co.kr/pricing/LGU_12GB_5G_online?carrier=LGU
- 목록: https://tossmobile.co.kr/pricing — 「LG U+ 망」 탭 > 「5G 라이트 요금제」
- 값의 출처: 목록·상세를 브라우저로 띄워 눈으로 읽은 값 + 그 화면이 부르는 내부 통로
  `GET https://api-public.toss.im/api/v3/mvno-growth/products/homepage` (planCode `LGU_12GB_5G_online`)
...
| 요금제 | 5G 12GB+ |
| 망·세대 | LGU / 5G |
| 요금 | 7개월 동안 월 25,800원, 그 뒤 40,800원 |
| 데이터 | 12GB + 1Mbps (상세 「다 써도 1Mbps 속도」) |
...
```
id            toss-5g-12gb-plus-lgu
carrier       토스모바일 / mvno / network LGU+
generation    5G
monthlyFee    40800
promo         { months: 7, feeDuring: 25800 }
dataGB        12
throttleMbps  1
