# 5G 라이트 200GB (KT 망) — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세): https://tossmobile.co.kr/pricing/KT_5G_200GB?carrier=KT
- 목록: https://tossmobile.co.kr/pricing — 「KT 망」 탭 > 「5G 라이트 요금제」
- 값의 출처: 목록·상세를 브라우저로 띄워 눈으로 읽은 값 + 그 화면이 부르는 내부 통로
  `GET https://api-public.toss.im/api/v3/mvno-growth/products/homepage` (planCode `KT_5G_200GB`)
...
| 요금제 | 5G 라이트 200GB |
| 망·세대 | KT / 5G |
| 요금 | 7개월 동안 월 35,800원, 그 뒤 54,800원 |
| 데이터 | 200GB + 10Mbps (상세 「다 써도 10Mbps 속도」) |
...
```
id            toss-5g-lite-200gb-kt
carrier       토스모바일 / mvno / network KT
generation    5G
monthlyFee    54800
promo         { months: 7, feeDuring: 35800 }
dataGB        200
throttleMbps  10
