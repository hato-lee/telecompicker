# 캐시백 71GB (LGU 망) — 원문에서 본 값 (2026-09-01 확인, 라운드 2 — 일 단위 데이터)

- 원문(상세): https://tossmobile.co.kr/pricing/LGU_71GB?carrier=LGU
- 목록: https://tossmobile.co.kr/pricing — 「LG U+ 망」 탭
- 값의 출처: 내부 통로 `GET https://api-public.toss.im/api/v3/mvno-growth/products/homepage`
  (planCode `LGU_71GB`) — 라운드 2 재확인 시점(2026-09-01 15:45 KST)까지 discountPolicyList 변동 없음.
...
| 요금제 | 캐시백 71GB |
| 망·세대 | LGU / LTE |
| 요금 | 24개월 동안 월 39,800원, 그 뒤 54,800원 |
...
```
id            toss-cashback-71gb-lgu
carrier       토스모바일 / mvno / network LGU+
generation    LTE
monthlyFee    54800
promo         { months: 24, feeDuring: 39800 }
dataGB        11
dailyDataGB   2
throttleMbps  3
