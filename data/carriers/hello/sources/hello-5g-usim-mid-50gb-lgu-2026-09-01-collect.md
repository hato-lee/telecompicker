# 5G 유심 중간요금제 50GB — 원문에서 본 값 (2026-09-01 확인)
...
| 칸 | 원문 |
|---|---|
| 요금제명 | 5G 유심 중간요금제 50GB |
| 머리줄(데이터) | 50GB +1Mbps 무제한 |
| 망 | LG U+ 망 |
| 세대 | 5G |
| 통화 | 기본제공 |
| 문자 | 기본제공 |
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 38,500원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "726",
 "pidx": "200",
 "paymentcode": "PDLB000267",
 "salesName": "5G 유심 중간요금제 50GB",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
 ...
 "dedicatedMonthlyOfferValue": "50",
 "dedicatedDailyOfferGubun": "G",
 "dedicatedDailyOfferValue": "",
 "dedicatedOfferSumValue": "50",
 ...
 "directPromotionDirectmallPrice": "38500",
...
```json
{
 "id": "hello-5g-usim-mid-50gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "5G 유심 중간요금제 50GB",
 "generation": "5G",
 "monthlyFee": 38500,
 "promo": null,
 "dataGB": 50,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 영상·부가통화 300분(스키마에 그릇 없음). 원문 요금제코드 PDLB000267."
}
```

### 왜 이 값인가

- `monthlyFee` 38,500원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
- `dataGB` 50 / `throttleMbps` 1
