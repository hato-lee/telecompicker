# The 착한 데이터 유심 0GB — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 4,900원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "926",
 "pidx": "140",
 "paymentcode": "PDLB000326",
 "salesName": "The 착한 데이터 유심 0GB",
 "salesBadge": "N",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "dedicatedMonthlyOfferValue": "0",
 "dedicatedDailyOfferGubun": "G",
 "dedicatedDailyOfferValue": "",
 "dedicatedOfferSumValue": "0",
 ...
 "directPromotionDirectmallPrice": "4900",
...
```json
{
 "id": "hello-the-chakhan-data-usim-0gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "The 착한 데이터 유심 0GB",
 "generation": "LTE",
 "monthlyFee": 4900,
 "promo": null,
 "dataGB": 0,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 영상·부가통화 110분(스키마에 그릇 없음). 원문 요금제코드 PDLB000326."
}
```

### 왜 이 값인가

- `monthlyFee` 4,900원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
- `dataGB` 0 / `throttleMbps` null (소진 후 제공 없음)
