# 5G 유심 통화 맘편히 3GB — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 7,990원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "418",
 "pidx": "244",
 "paymentcode": "PDLB000198",
 "salesName": "5G 유심 통화 맘편히 3GB",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
 ...
 "dedicatedViedocallsValue": "100",
 "directPromotionDirectmallPrice": "7990",
...
```json
{
 "id": "hello-5g-usim-call-easy-3gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "5G 유심 통화 맘편히 3GB",
 "generation": "5G",
 "monthlyFee": 7990,
 "promo": null,
 "dataGB": 3,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 영상·부가통화 100분(스키마에 그릇 없음). 원문 요금제코드 PDLB000198."
}
```

### 왜 이 값인가

- `monthlyFee` 7,990원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
