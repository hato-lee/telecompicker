# 조건없는 USIM LTE 26 — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 28,600원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "73",
 "pidx": "202",
 "paymentcode": "PDB0000110",
 "salesName": "조건없는 USIM LTE 26",
 "salesBadge": "",
 "telecom": "KT",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "directPromotionDirectmallPrice": "28600",
...
```json
{
 "id": "hello-nocondition-usim-lte-26-kt",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "KT",
 "name": "조건없는 USIM LTE 26",
 "generation": "LTE",
 "monthlyFee": 28600,
 "promo": null,
 "dataGB": 2.5,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDB0000110."
}
```

### 왜 이 값인가

- `monthlyFee` 28,600원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
