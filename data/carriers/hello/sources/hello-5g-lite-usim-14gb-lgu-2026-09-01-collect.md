# 5G 라이트 유심 14GB — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 36,300원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "827",
 "pidx": "200",
 "paymentcode": "PDLB000303",
 "salesName": "5G 라이트 유심 14GB",
 "salesBadge": "N, C",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
 ...
 "dedicatedMonthlyOfferValue": "14",
 "dedicatedDailyOfferGubun": "G",
 "dedicatedDailyOfferValue": "",
 "dedicatedOfferSumValue": "14",
 ...
 "directPromotionDirectmallPrice": "36300",
...
```json
{
 "id": "hello-5g-lite-usim-14gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "5G 라이트 유심 14GB",
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 딱지 「U+결합할인」 대상 — 결합할인 값은 이번 범위 밖이라 담지 않았다. 영상·부가통화 300분(스키마에 그릇 없음). 원문 요금제코드 PDLB000303."
}
```

### 왜 이 값인가

- `monthlyFee` 36,300원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
- `dataGB` 14 / `throttleMbps` 1
