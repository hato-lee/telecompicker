# 사과 5G 스페셜 유심 180GB — 원문에서 본 값 (2026-09-01 확인)
...
| 칸 | 원문 |
|---|---|
| 요금제명 | 사과 5G 스페셜 유심 180GB |
| 머리줄(데이터) | 180GB +10Mbps 무제한 |
| 망 | LG U+ 망 |
| 세대 | 5G |
| 통화 | 기본제공 |
| 문자 | 기본제공 |
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 60,500원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "381",
 "pidx": "200",
 "paymentcode": "PDLB000151",
 "salesName": "사과 5G 스페셜 유심 180GB",
 "salesBadge": "C",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
 ...
 "dedicatedMonthlyOfferValue": "180",
 "dedicatedDailyOfferGubun": "G",
 "dedicatedDailyOfferValue": "",
 "dedicatedOfferSumValue": "180",
 "dedicatedDataDepletionRate": "5",
...
```json
{
 "id": "hello-sagwa-5g-special-usim-180gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "사과 5G 스페셜 유심 180GB",
 "generation": "5G",
 "monthlyFee": 60500,
 "promo": null,
 "dataGB": 180,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 딱지 「U+결합할인」 대상 — 결합할인 값은 이번 범위 밖이라 담지 않았다. 영상·부가통화 300분(스키마에 그릇 없음). 원문 요금제코드 PDLB000151."
}
```

### 왜 이 값인가

- `monthlyFee` 60,500원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
- `dataGB` 180 / `throttleMbps` 10
