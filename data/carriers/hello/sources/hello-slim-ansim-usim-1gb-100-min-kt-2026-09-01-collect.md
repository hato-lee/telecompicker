# 슬림 안심 USIM 1GB 100분 — 원문에서 본 값 (2026-09-01 확인)
...
```json
{
 "idx": "360",
 "pidx": "156",
 "paymentcode": "PDB0000269",
 "salesName": "슬림 안심 USIM 1GB 100분",
 "salesBadge": "B",
 "telecom": "KT",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
...
```json
{
 "id": "hello-slim-ansim-usim-1gb-100-min-kt",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "KT",
 "name": "슬림 안심 USIM 1GB 100분",
 "generation": "LTE",
 "monthlyFee": 9900,
 "promo": null,
 "dataGB": 1,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDB0000269."
}
```
