# 착한 페이백 데이터 USIM 1GB — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 26,900원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "159",
 "pidx": "62",
 "paymentcode": "PDB0000131",
 "salesName": "착한 페이백 데이터 USIM 1GB",
 "salesBadge": "",
 "telecom": "KT",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "directPromotionDirectmallPrice": "26900",
...
```json
{
 "id": "hello-chakhan-payback-data-usim-1gb-kt",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "KT",
 "name": "착한 페이백 데이터 USIM 1GB",
 "generation": "LTE",
 "monthlyFee": 26900,
 "promo": null,
 "dataGB": 1,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 영상·부가통화 200분(스키마에 그릇 없음). 원문 요금제코드 PDB0000131."
}
```

### 왜 이 값인가

- `monthlyFee` 26,900원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
