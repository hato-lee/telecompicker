# 보편 안심 유심 15GB 100분 — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 28,820원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "311",
 "pidx": "143",
 "paymentcode": "PDLB000060",
 "salesName": "보편 안심 유심 15GB 100분",
 "salesBadge": "B, C",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "directPromotionDirectmallPrice": "28820",
...
```json
{
 "id": "hello-bopyeon-ansim-usim-15gb-100-min-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "보편 안심 유심 15GB 100분",
 "generation": "LTE",
 "monthlyFee": 28820,
 "promo": null,
 "dataGB": 15,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 딱지 「U+결합할인」 대상 — 결합할인 값은 이번 범위 밖이라 담지 않았다. 원문 요금제코드 PDLB000060."
}
```

### 왜 이 값인가

- `monthlyFee` 28,820원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
