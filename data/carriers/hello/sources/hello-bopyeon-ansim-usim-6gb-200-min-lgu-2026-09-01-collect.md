# 보편 안심 유심 6GB 200분 — 원문에서 본 값 (2026-09-01 확인)
...
| 칸 | 원문 |
|---|---|
| 요금제명 | 보편 안심 유심 6GB 200분 |
| 머리줄(데이터) | 6GB +1Mbps 무제한 |
| 망 | LG U+ 망 |
| 세대 | LTE |
| 통화 | 200분 |
| 문자 | 100건 |
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 15,200원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "449",
 "pidx": "143",
 "paymentcode": "PDLB000218",
 "salesName": "보편 안심 유심 6GB 200분",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "directPromotionDirectmallPrice": "15200",
...
```json
{
 "id": "hello-bopyeon-ansim-usim-6gb-200-min-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "보편 안심 유심 6GB 200분",
 "generation": "LTE",
 "monthlyFee": 15200,
 "promo": null,
 "dataGB": 6,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDLB000218."
}
```

### 왜 이 값인가

- `monthlyFee` 15,200원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
- `dataGB` 6 / `throttleMbps` 1
