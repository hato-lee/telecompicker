# 조건없는 USIM LTE 수다 1.5GB — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 25,300원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "103",
 "pidx": "202",
 "paymentcode": "PDB0000117",
 "salesName": "조건없는 USIM LTE 수다 1.5GB",
 "salesBadge": "",
 "telecom": "KT",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "dedicatedCallsValue": "185",
 "dedicatedSmsGubun": "L",
 "dedicatedSmsValue": "",
 "dedicatedViedocallsGubun": "N",
 "dedicatedViedocallsValue": "",
 "directPromotionDirectmallPrice": "25300",
...
```json
{
 "id": "hello-nocondition-usim-lte-suda-1-5gb-kt",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "KT",
 "name": "조건없는 USIM LTE 수다 1.5GB",
 "generation": "LTE",
 "monthlyFee": 25300,
 "promo": null,
 "dataGB": 1.5,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDB0000117."
}
```

### 왜 이 값인가

- `monthlyFee` 25,300원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
- `dataGB` 1.5 / `throttleMbps` null (소진 후 제공 없음)
- `voiceMinutes` 185 / `smsIncluded` true
