# 슬림 안심 유심 2.5GB 250분 — 원문에서 본 값 (2026-09-01 확인)
...
```json
{
 "idx": "466",
 "pidx": "143",
 "paymentcode": "PDLB000220",
 "salesName": "슬림 안심 유심 2.5GB 250분",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
...
```json
{
 "id": "hello-slim-ansim-usim-2-5gb-250-min-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "슬림 안심 유심 2.5GB 250분",
 "generation": "LTE",
 "monthlyFee": 13200,
 "promo": null,
 "dataGB": 2.5,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDLB000220."
}
```

### 왜 이 값인가

- `monthlyFee` 13,200원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
