# DATA 걱정없는 유심 1GB — 원문에서 본 값 (2026-09-01 확인)
...
```json
{
 "idx": "445",
 "pidx": "139",
 "paymentcode": "PDLB000212",
 "salesName": "DATA 걱정없는 유심 1GB",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "directPromotionAfterPrice": "11550",
 "tetheringAllowGb": "S",
 "tetheringAllowValue": "",
 "voiceDetailSpec": "",
...
```json
{
 "id": "hello-data-worryfree-usim-1gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "DATA 걱정없는 유심 1GB",
 "generation": "LTE",
 "monthlyFee": 11550,
 "promo": {
  "months": 7,
  "feeDuring": 7500,
  "note": "원문 표시 「7개월 후 11,550원」"
 },
 "dataGB": 1,
 "throttleMbps": 1,
 "voiceMinutes": null,
 ...
 "memo": "원문 유의사항 「7개월간 추가할인 프로모션이 적용될 경우, 신규가입에 한 해 적용되며 요금제 변경 시 제외됩니다.」 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 영상·부가통화 110분(스키마에 그릇 없음). 원문 요금제코드 PDLB000212."
}
```

### 왜 이 값인가

- `monthlyFee` 11,550원 / `promo` 7개월 7,500원 — 원문 가격 옆 딱지가 「7개월 후 11,550원」이고 큰 숫자가 7,500원이다. 즉 앞 7달은 할인가, 그 뒤가 제값.
