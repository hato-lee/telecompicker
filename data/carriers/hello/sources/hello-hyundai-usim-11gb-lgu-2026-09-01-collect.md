# 현대홈쇼핑 유심 11GB — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | 혜택 요금제 |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 35,190원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "1241",
 "pidx": "139",
 "paymentcode": "PDLB000406",
 "salesName": "현대홈쇼핑 유심 11GB",
 "salesBadge": "N, C, MI",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "directPromotionDirectmallPrice": "35190",
...
```json
{
 "id": "hello-hyundai-usim-11gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "현대홈쇼핑 유심 11GB",
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 머리줄에 「+일 2GB」 추가 제공이 더 있으나 담지 않았다 — 스키마에 일 단위 그릇이 없다(DECIDED 2026-09-01). 원문 분류 딱지 「혜택 요금제」. 원문 딱지 「U+결합할인」 대상 — 결합할인 값은 이번 범위 밖이라 담지 않았다. 영상·부가통화 300분(스키마에 그릇 없음). 원문 요금제코드 PDLB000406."
}
```

### 왜 이 값인가

- `monthlyFee` 35,190원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
