# The 착한 데이터 유심 9GB 3000분 — 원문에서 본 값 (2026-09-01 확인)
...
```json
{
 "idx": "486",
 "pidx": "140",
 "paymentcode": "PDLB000222",
 "salesName": "The 착한 데이터 유심 9GB 3000분",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "dedicatedCallsValue": "3000",
 "dedicatedSmsGubun": "B",
 "dedicatedSmsValue": "1000",
...
```json
{
 "id": "hello-the-chakhan-data-usim-9gb-3000-min-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "The 착한 데이터 유심 9GB 3000분",
 "generation": "LTE",
 "monthlyFee": 16900,
 "promo": null,
 "dataGB": 9,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDLB000222."
}
```
...
- `voiceMinutes` 3000 / `smsIncluded` true
