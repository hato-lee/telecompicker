# 5G 유심 10GB 200분 — 원문에서 본 값 (2026-09-01 확인)
...
```json
{
 "idx": "527",
 "pidx": "245",
 "paymentcode": "PDLB000232",
 "salesName": "5G 유심 10GB 200분",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
...
```json
{
 "id": "hello-5g-usim-10gb-200-min-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "5G 유심 10GB 200분",
 "generation": "5G",
 "monthlyFee": 9900,
 "promo": null,
 "dataGB": 10,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDLB000232."
}
```

### 왜 이 값인가

- `monthlyFee` 9,900원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
