# 슬림 안심 유심 2.5GB 200분 — 원문에서 본 값 (2026-09-01 확인)
...
| 칸 | 원문 |
|---|---|
| 요금제명 | 슬림 안심 유심 2.5GB 200분 |
| 머리줄(데이터) | 2.5GB +1Mbps 무제한 |
| 망 | LG U+ 망 |
| 세대 | LTE |
| 통화 | 200분 |
| 문자 | 100건 |
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 10,500원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "465",
 "pidx": "143",
 "paymentcode": "PDLB000219",
 "salesName": "슬림 안심 유심 2.5GB 200분",
 "salesBadge": "",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 ...
 "directPromotionDirectmallPrice": "10500",
...
```json
{
 "id": "hello-slim-ansim-usim-2-5gb-200-min-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "슬림 안심 유심 2.5GB 200분",
 "generation": "LTE",
 "monthlyFee": 10500,
 "promo": null,
 "dataGB": 2.5,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDLB000219."
}
```

### 왜 이 값인가

- `monthlyFee` 10,500원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
- `dataGB` 2.5 / `throttleMbps` 1
