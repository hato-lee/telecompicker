# 5G 스페셜 유심 180GB — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 55,000원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "289",
 "pidx": "200",
 "paymentcode": "PDLB000030",
 "salesName": "5G 스페셜 유심 180GB",
 "salesBadge": "C",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
 ...
 "directPromotionDirectmallPrice": "55000",
...
```json
{
 "id": "hello-5g-special-usim-180gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "5G 스페셜 유심 180GB",
 "generation": "5G",
 "monthlyFee": 55000,
 "promo": null,
 "dataGB": 180,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 딱지 「U+결합할인」 대상 — 결합할인 값은 이번 범위 밖이라 담지 않았다. 영상·부가통화 300분(스키마에 그릇 없음). 원문 요금제코드 PDLB000030."
}
```

### 왜 이 값인가

- `monthlyFee` 55,000원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
