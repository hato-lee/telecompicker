# 데이터 걱정없는 USIM 2.5GB — 원문에서 본 값 (2026-09-01 확인)
...
```json
{
 "idx": "320",
 "pidx": "66",
 "paymentcode": "PDB0000265",
 "salesName": "데이터 걱정없는 USIM 2.5GB",
 "salesBadge": "",
 "telecom": "KT",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
...
```json
{
 "id": "hello-data-worryfree-usim-2-5gb-kt",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "KT",
 "name": "데이터 걱정없는 USIM 2.5GB",
 "generation": "LTE",
 "monthlyFee": 25100,
 "promo": null,
 "dataGB": 2.5,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 영상·부가통화 150분(스키마에 그릇 없음). 원문 요금제코드 PDB0000265."
}
```
