# 5G 라이트 유심 15GB 300분 — 원문에서 본 값 (2026-09-01 확인)
...
| 분류 딱지 | (없음) |
| 가격 옆 딱지 | 평생요금 |
| 월 요금 | 19,900원 (부가세 포함 — 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」) |
...
```json
{
 "idx": "1140",
 "pidx": "262",
 "paymentcode": "PDLB000387",
 "salesName": "5G 라이트 유심 15GB 300분",
 "salesBadge": "N",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
 ...
 "directPromotionDirectmallPrice": "19900",
...
```json
{
 "id": "hello-5g-lite-usim-15gb-300-min-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "5G 라이트 유심 15GB 300분",
 "generation": "5G",
 "monthlyFee": 19900,
 "promo": null,
 "dataGB": 15,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 요금제코드 PDLB000387."
}
```

### 왜 이 값인가

- `monthlyFee` 19,900원 — 원문 가격 옆 딱지가 「평생요금」이다. 기간 한정 할인이 아니라 계속 내는 값이므로 `promo`는 `null`.
