# 시니어 안심보험 유심 4GB — 원문에서 본 값 (2026-09-01 확인, 라운드 2)
...
- 유의사항 출처: `POST https://direct.lghellovision.net/phone/commNoticeNew.do` (body `paymentCode=PDLB000380&itemGubun=USIM&cpGubun=C`)
- 요금제코드: `PDLB000380`
- 확인 날짜: 2026-09-01
...
```json
{
 "idx": "1100",
 "pidx": "193",
 "paymentcode": "PDLB000380",
 "salesName": "시니어 안심보험 유심 4GB",
 "salesBadge": "N, MI",
 "telecom": "LGU",
 "title": "LTE USIM 요금제",
 "usimType": "LTE",
 "salesBadgeNm": "롯데손해보험",
 "salesBadgeTextColor": "FF0000",
 "salesBadgeBgColor": "D5D5D5",
 ...
 "directPromotionDirectmallPrice": "13500",
 ...
 "tetheringAllowValue": "",
 "voiceDetailSpec": "",
 "benefitList": "(사은품 5건 — 요금이 아니라 담지 않는다)"
}
```
...
```json
{
 "id": "hello-senior-ansim-insurance-usim-4gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "시니어 안심보험 유심 4GB",
 "generation": "LTE",
 "monthlyFee": 13500,
 "promo": null,
 "dataGB": 4,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 연령제한 요금제 유의사항 원문 「시니어 요금제 : 만 65세 이상, 1인 1회선 한정」. 원문 요금제코드 PDLB000380."
}
```
...
- `monthlyFee` — 원문 가격 옆 딱지가 「평생요금」(directPromotionInfotext=A) → monthlyFee=13500, promo=null
- `dataGB`=4 / `dailyDataGB`=null / `throttleMbps`=1
