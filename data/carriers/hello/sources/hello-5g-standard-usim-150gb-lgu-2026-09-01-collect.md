# 5G 스탠다드 유심 150GB — 원문에서 본 값 (2026-09-01 확인)
...
```json
{
 "idx": "412",
 "pidx": "200",
 "paymentcode": "PDLB000191",
 "salesName": "5G 스탠다드 유심 150GB",
 "salesBadge": "C",
 "telecom": "LGU",
 "title": "5G USIM 요금제",
 "usimType": "5G",
...
```json
{
 "id": "hello-5g-standard-usim-150gb-lgu",
 "carrier": "헬로모바일",
 "carrierType": "mvno",
 "network": "LGU+",
 "name": "5G 스탠다드 유심 150GB",
 "generation": "5G",
 "monthlyFee": 49900,
 "promo": null,
 "dataGB": 150,
 ...
 "memo": "원문 가격 옆 표시 「평생요금」 — 이 값이 계속 내는 월정액이다(기간 한정 할인 아님). 부가세: 원문 유의사항 「월 기본료 및 국내 통화료는 부가세 포함금액입니다」. 원문 딱지 「U+결합할인」 대상 — 결합할인 값은 이번 범위 밖이라 담지 않았다. 영상·부가통화 300분(스키마에 그릇 없음). 원문 요금제코드 PDLB000191."
}
```
