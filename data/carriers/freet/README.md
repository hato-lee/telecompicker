...
## 라운드 2 갱신 (2026-09-01) — 일 단위 데이터 35개를 담았다

게이트 2 결정(`dailyDataGB` 그릇 신설)으로 아래 35개를 `freet.json`에 **추가**했다(기존 142개는 그대로, 총 177개).
값 변환식은 위 표와 동일하게 적용했다 — `freeData` 문법만 추가: 「월11GB+매일2GB」→`dataGB 11, dailyDataGB 2`,
「매일5GB」→`dataGB 0, dailyDataGB 5`, 「월10GB+매일2GB」→`dataGB 10, dailyDataGB 2`.
근거·전체 목록: `sources/daily-batch-2026-09-01-round2-daily.md`.
연령 전용 요금제는 195개 전부를 훑어도 **없었다**(라운드 1 README 하단 참고) — 이번 라운드에서 새로 담을 것 없음.

## 안 담은 것 (2026-09-01 · 195개 중 18개, 라운드 2 갱신)
