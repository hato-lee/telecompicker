# 데이터 맘껏 15GB+/300분(다이소 5000P) — 원문에서 본 값 (2026-09-01 확인)

- 원문(상세 팝업): https://www.ktmmobile.com/rate/rateLayer.do?rateAdsvcCtgCd=12&rateAdsvcGdncSeq=488&rateAdsvcCd=PL2543136
- 목록 출처: `POST https://www.ktmmobile.com/rate/rateContentAjax.do` body `rateAdsvcCtgCd=12` (그룹: 「데이터 맘껏」)
- 상세 출처: `GET https://www.ktmmobile.com/rate/rateLayer.do?rateAdsvcCtgCd=12&rateAdsvcGdncSeq=488&rateAdsvcCd=PL2543136` (요금제 코드 PL2543136)

## 원문 표에 적힌 그대로

| 칸 | 원문 |
|---|---|
| 요금제명 | 데이터 맘껏 15GB+/300분(다이소 5000P) |
...
```
id            ktm-data-mamkkeot-15gb-300m-daiso
