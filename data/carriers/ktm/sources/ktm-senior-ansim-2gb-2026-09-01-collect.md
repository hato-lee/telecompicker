# 시니어 안심 2GB+ — 원문에서 본 값 (2026-09-01 확인, 라운드 2)

- 원문(상세 팝업): https://www.ktmmobile.com/rate/rateLayer.do?rateAdsvcCtgCd=17&rateAdsvcGdncSeq=51&rateAdsvcCd=PL203D127
...
```json
{
 ...
 "ageMin": 65,
 "ageMax": null,
 "sourceUrl": "https://www.ktmmobile.com/rate/rateLayer.do?rateAdsvcCtgCd=17&rateAdsvcGdncSeq=51&rateAdsvcCd=PL203D127",
 "checkedAt": "2026-09-01",
 "memo": "정가 28,000원, 프로모션 요금 5,900원 — 「월정액은 실제 개통 시점의 판매가로 적용」(상세 유의사항). 상시 변동 가능. 상세 팝업 원문 「만 65세 이상 개인 고객만 가입 가능한 시니어 전용 요금제」."
}
```
