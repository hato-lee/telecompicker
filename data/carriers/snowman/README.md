...
| 무엇 | 개수 | 무엇이었나 |
|---|---|---|
| 일 단위 데이터 | ~~7~~ **0** (2026-09-01 라운드 2에서 7건 전부 담음, `dailyDataGB` 신설) | 스노우맨 일5GB+5Mbps, 통화기본 데이터매일5GB+, LTE데이터선택10G, 데이터11GB+일2GB++ ×4 |
| 복지 | 0 | 「복지요금제」 아코디언이 **비어 있다** |
| 나이 제한 | 0 | — |

39건 중 **32건**을 담았다. **라운드 2(2026-09-01)에서 일 단위 데이터 7건을 추가로 담아 39건 — 이 사업자는 이제 원문 전부를 담았다.**
